...
ipython -i train.py -- \
    ...
    --data-config    HadronicSMEFT/data/delphesJet_ctGIm_d_parton.yaml\
    --network-config HadronicSMEFT/networks/ParticleNetGlobal_likelihoodFree.py\
    --model-prefix   /scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/models/ctGIm-v2/ctGIm_d_parton\
