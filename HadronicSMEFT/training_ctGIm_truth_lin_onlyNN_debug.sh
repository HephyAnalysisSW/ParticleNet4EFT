...
ipython -i train.py --\
    ...
    --data-config    HadronicSMEFT/data/delphesJet_ctGIm_truth_lin_onlyNN.yaml\
    --network-config HadronicSMEFT/networks/ParticleNetNN1D_likelihoodFree.py\
    --model-prefix   /scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/models/ctGIm-truth-lin-onlyNN-debug/ctGIm-truth\
