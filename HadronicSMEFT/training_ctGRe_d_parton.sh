...
ipython -i train.py -- \
    ...
    --data-config    HadronicSMEFT/data/delphesJet_ctGRe_d_parton.yaml\
    --network-config HadronicSMEFT/networks/ParticleNetGlobal_likelihoodFree.py\
    --model-prefix   /scratch-cbe/users/robert.schoefbeck/HadronicSMEFT/models/ctGRe-v2/ctGRe_d_parton\
