...
def get_model(data_config, **kwargs):
    conv_params =  [(5, (20,20,20)),(5, (10,10,10))]         # Note to myself: first parameter in conv_params is (probably) the number of connected neighbours
    fc_params = [(10, 0.0)]           # fully connected layer (hidden_size, drop_out) after GNN for array based input
